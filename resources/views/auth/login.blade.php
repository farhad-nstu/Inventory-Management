            ...
            <div class="panel panel-color panel-primary panel-pages">
                ...
                <form class="form-horizontal m-t-20" method="POST" action="{{ route('login') }}">
                    ...
                    <div class="form-group ">
                        <div class="col-xs-12">
                            <input class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }} input-lg "
                             id="email" type="email" name="email" value="{{ old('email') }}" required autofocus placeholder="Email Address">
