                            ...
                            <div class="col-md-8 ">
                                <div class="panel panel-info">
                                    <div class="panel-heading">
                                        <h3 class="panel-title text-white">Advanced Salary Provide</h3>
                                                   
                                    </div>
                                    <a href="{{ route('add.advancedsalary') }}" class="pull-right btn btn-danger btn-sm">All Advanced Salary</a>
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <label for="exampleInputPassword1">Salary Month</label>
